  ...
  return (
    <Box sx={{ mb: 3, pb: 3, borderBottom: "1px solid", borderColor: "divider" }}>
      <FormControl component="fieldset" error={!!error} fullWidth>
        <FormLabel sx={{
          mb: 1, fontSize: "0.88rem", fontWeight: 600,
  ...
  return (
    <Box sx={{ mb: 2.5 }}>
      ...
      <LinearProgress variant="determinate" value={pct}
        sx={{
          height: 10, borderRadius: 8, bgcolor: "#f0f4f8",
    ...
    <Box sx={{
      ...
      <Box sx={{ maxWidth: 720, mx: "auto" }}>
        ...
        <LinearProgress variant="determinate" value={progress}
          sx={{
            mb: 3, height: 5, borderRadius: 8, bgcolor: "background.blue",
        ...
        <Paper elevation={2} sx={{
            ...
            <Box>
              ...
              <Grid container spacing={2.5}>
                ...
                <Grid item xs={12}>
                  ...
                  <Box sx={{
                    p: 2.5, bgcolor: "background.subtle", borderRadius: 3,
          ...
          {step === 1 && (
            <Box>
              ...
              <Box sx={{ display: "flex", gap: 2, mb: 3 }}>
                <Box sx={{
                  flex: 1, textAlign: "center", p: 2, bgcolor: "background.subtle",
          ...
          {step === 2 && (
            <Box>
              ...
              <Box sx={{
                mt: 2, p: 2, bgcolor: "background.blue", borderRadius: 3,
                ...
                <Box>
                  ...
                  <Box sx={{
                    ...
                    {photoPreview
                      ...
                      : <Avatar sx={{
                        width: 56, height: 56, bgcolor: "background.blue",
                  ...
                  <Box sx={{
                    ...
                    <Box sx={{ maxWidth: 280, mx: "auto" }}>
                      <LinearProgress variant="determinate"
                        ...
                        sx={{
                          height: 12, borderRadius: 8, bgcolor: "rgba(0,0,0,0.08)",
                  ...
                  {/* Note médicale */}
                  <Box sx={{
                    p: 2, bgcolor: "background.orange", borderRadius: 3, mb: 3,
