...
function ChildDetailsDialog({ child, open, onClose }) {
  ...
  const dsFields = [
    ...
    { label: "TSA/TED (PR_QN1_A)", value: child.PR_QN1_A, note: "0=Non, 1=Non diagnostiqué, 2=Diagnostiqué" },
    { label: "Trouble rare (PR_QN1_B)", value: child.PR_QN1_B, note: "0=Non, 1=Non diagnostiqué, 2=Diagnostiqué" },
    { label: "Asthme (PR_QN1_C)", value: child.PR_QN1_C, note: "0=Non…2=Diagnostiqué" },
    { label: "Santé mentale (PR_QN1_D)", value: child.PR_QN1_D, note: "0=Non…2=Diagnostiqué" },
    { label: "Épilepsie (PR_QN1_G)", value: child.PR_QN1_G, note: "0=Non…2=Diagnostiqué" },
