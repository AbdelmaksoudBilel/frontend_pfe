            ...
            <Box sx={{ mb:0.5 }}>
              {msg.fileType.startsWith("image") ? (
                ...
                <Box sx={{ display:"flex",alignItems:"center",gap:1,p:1.5,
                  ...
                  <VideocamIcon sx={{ color:isUser?"white":"primary.main" }} />
                  <AppText variant="caption" sx={{ color:isUser?"white":"text.primary" }}>
                    Vidéo envoyée
                  </AppText>
                </Box>
              )}
    ...
    <Box sx={{
      ...
      <Box sx={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:0.5,flexShrink:0 }}>
        ...
        <IconButton size="small"
          ...
          sx={{ p:0.3,opacity:0,"&:hover":{opacity:1,color:"error.main"} }}>
...
export default function ChatPage() {
  ...
  const handleNewConv = () => {
    api.get("/children").then(r => {
      if (r.data?.length > 0) createConv(r.data[0]._id);
    }).catch(()=>{});
  };
  ...
  const handleFileChange = (e) => {
    ...
    if (file) { setAttachedFile(file); e.target.value=""; }
  };
  ...
  // ─────────────────────────────────────────────────────────────
  const sidebar = (
    <Box sx={{ width:SIDEBAR_W,height:"100%",display:"flex",
      ...
      <Box sx={{ p:2,borderBottom:"1px solid",borderColor:"divider" }}>
        ...
        <AppButton fullWidth size="small" startIcon={<AddIcon />} onClick={handleNewConv}>
      ...
      {/* Label */}
      <Box sx={{ px:2,py:1 }}>
        <AppText variant="caption" sx={{ color:"text.disabled",fontWeight:700,
      ...
      <Box sx={{ flex:1,overflowY:"auto",py:0.5,
        ...
        {filteredConvs.length === 0 ? (
          <Box sx={{ p:3,textAlign:"center" }}>
            ...
            {!search && (
              <AppButton size="small" sx={{ mt:1.5 }} onClick={handleNewConv}>
                Commencer
              </AppButton>
            )}
          </Box>
            ...
            <Tooltip key={i} title={b.tip}>
              <IconButton size="small" onClick={b.action}
                sx={{ flex:1,borderRadius:2,py:1,
                  "&:hover":{ bgcolor: b.color ? "#FFF5F5" : "background.blue",
  ...
  const chatZone = (
    <Box sx={{ flex:1,display:"flex",flexDirection:"column",
      ...
      <Box sx={{ px:2.5,py:1.5,borderBottom:"1px solid",borderColor:"divider",
        ...
        <Box sx={{ flex:1 }}>
          ...
          <Box sx={{ display:"flex",alignItems:"center",gap:0.5 }}>
            ...
            <AppText variant="caption" sx={{ color:"success.main",fontWeight:600 }}>
              En ligne · TSA & DI
            </AppText>
          </Box>
        </Box>
      ...
      <Box sx={{ flex:1,overflowY:"auto",px:{ xs:2,md:3 },py:2,
        ...
        {!activeConv && (
          <Box sx={{ textAlign:"center",mt:{ xs:6,md:10 } }}>
            ...
            <AppText variant="h4" sx={{ fontWeight:800,mb:1 }}>
            ...
            <AppButton startIcon={<AddIcon />} onClick={handleNewConv}>
              Nouvelle conversation
            </AppButton>
          </Box>
        )}
            ...
            <Box sx={{ display:"flex",flexWrap:"wrap",gap:1,
              ...
              {[
                ...
                <Chip key={q} label={q} size="small"
                  onClick={()=>setInput(q)}
                  sx={{ cursor:"pointer",bgcolor:"background.blue",
      ...
      {attachedFile && (
        <Box sx={{ px:2.5,py:1,bgcolor:"white",
          ...
          <Box sx={{ display:"flex",alignItems:"center",gap:1,
            ...
            <AppText variant="caption" sx={{ color:"primary.dark",fontWeight:600,
